...
Implements:
 ...
 -Organized into reusable modules: Data Classes, ChatManager, CryptoManager, FirebaseManager, StorageManager, and SQLLiteManager.
 ...
 -FirebaseManager: provides efficient Firebase cloud storage of conversation and token usage history, allowing these to be synchronized between devices and with my companion Chat-T (chatty) web application.
